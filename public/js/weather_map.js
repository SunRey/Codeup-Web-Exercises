...
(function() {
    ...
    function googleGeocoder (userLocation) {
    ...
    function weatherCast (data) {
        ...
        for(var i=0; i < data.list.length; i++) {
            ...
            temptatures += '<strong>Winds</strong>: &nbsp' + Math.round(data.list[i].speed) + ' mph towards the ' + degToDirection(data.list[i].deg)  + ' </p>';
